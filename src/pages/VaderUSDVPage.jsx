const VaderUSDVPage = () => {
    return (
        <div className="w-full flex flex-col justify-center">
            ...
            <div className="W-1/2 flex flex-row justify-center p-10 pt-0 h-full">
        <div className="w-1/2 m-2 flex flex-col rounded-xl bg-gray-200">
        ...
        <div className="w-1/2 m-2 flex justify-center rounded-xl bg-gray-200">

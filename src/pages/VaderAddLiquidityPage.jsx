...
const VaderAddLiquidityPage = () => {
    return (
        <div className="flex justify-center items-center flex-col w-full lg:max-w-xl mx-auto">
            <h1 className="justify-center w-full text-center text-3xl font-extrabold m-2 text-white">Add Liquidity</h1>
            <div className="flex flex-col justify-center p-10 h-full pt-0">
                <div className="liquidity-container p-4 rounded-xl text-sm text-left bg-gray-200 flex flex-col">
                    <p><strong>Tip: </strong> When you add liquidity, you will recieve pool tokens representing your position. These tokens automatically earn fees proportional to your share of the pool, and can be redeemed at any time.</p>
                </div>
